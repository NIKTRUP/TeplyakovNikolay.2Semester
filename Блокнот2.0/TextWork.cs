...
namespace Блокнот2._0
{
    public static class TextWork
    {
        ...
        public static void mEditEnableds(ref TextBox notebox, ref ToolStripMenuItem mEditCopy, 
            ref ToolStripMenuItem mEditCut, ref ToolStripMenuItem mEditDel  ,
            ref ToolStripMenuItem mEditGo, ref ToolStripMenuItem mEditFind)
        {
